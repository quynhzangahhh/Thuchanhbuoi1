...
VALUES
('NV01', 'Nguy?n Th? Thu', 'N?', 'Hà N?i', '0982626521', 'thu@gmail.com', 'K? toán'),
('NV02', 'Lê Vãn Nam', 'Nam', 'B?c Ninh', '0972525252', 'nam@gmail.com', 'V?t tý'),
('NV03', 'Tr?n H?a B?nh', 'N?', 'Hà N?i', '0328388388', 'hb@gmail.com', 'K? toán');

INSERT INTO Sanpham (masp, mahangsx, tensp, soluong, mausac, giaban, donvitinh, mota)
VALUES
('SP01', 'H02', 'Galaxy Note11', 50, 'Ð?', 1900000, 'Chi?c', 'Hàng c?n c?o c?p'),
('SP02', 'H01', 'F1 Plus', 100, 'Xám', 7000000, 'Chi?c', 'Hàng c?n c?o c?p'),
('SP03', 'H02', 'F3 lite', 200, 'Nâu', 3000000, 'Chi?c', 'Hàng ph? thông'),
('SP04', 'H03', 'Vjoy3', 200, 'Xám', 1500000, 'Chi?c', 'Hàng ph? thông'),
('SP05', 'H01', 'Galaxy V21', 500, 'Nâu', 8000000, 'Chi?c', 'Hàng c?n c?o c?p');
